...
namespace Reports.Services.Helper
{
    public class FileHelper : IFileHelper
    {
        ...
        private CsvDataTable GetDefaultDataTable(string filePath)
        {
        ...
        private CsvDataTable GetProviderDataTable(string filePath, string provider)
        {
            var csvDataTable = new CsvDataTable();
        ...
        public async Task<ProvidersResponse> GetProviders(Entities.File file)
        {
        ...
        public async Task<DefaultResponse> ProviderSaveAsExcel(string provider, Entities.User user, Entities.File file, Entities.Report report)
        {
        ...
        public async Task<DefaultResponse> ProviderSaveAsPdf(string provider, Entities.User user, Entities.File file, Entities.Report report)
        {
            var csvDataTable = GetProviderDataTable(file.Path + file.Name, provider);
